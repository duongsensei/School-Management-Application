    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Good job!", 1, new DateTime(2025, 5, 23, 13, 15, 49, 168, DateTimeKind.Local).AddTicks(9300), 65, 40, 0, 1, 1, 1, 80 },
                    { 2, "Excellent work!", 0, new DateTime(2025, 5, 23, 13, 15, 49, 168, DateTimeKind.Local).AddTicks(9305), 75, 40, 0, 2, 2, 2, 90 },
                    { 3, "Excellent work!", 0, new DateTime(2025, 5, 23, 13, 15, 49, 168, DateTimeKind.Local).AddTicks(9307), 75, 40, 0, 3, 3, 3, 90 }
                });
